...
export type DiagnosticType = 'disease_detection' | 'risk_prediction' | 'treatment_recommendation' | 'drug_discovery' | 'prognosis_estimation' | 'pathology_analysis';
...
export type BiosensorType = 'wearable_watch' | 'wearable_patch' | 'wearable_clothing' | 'lab_on_chip' | 'implantable' | 'point_of_care';
...
export type SensorType = 'heart_rate' | 'blood_pressure' | 'oxygen_saturation' | 'glucose' | 'temperature' | 'ecg' | 'accelerometer' | 'gyroscope' | 'hydration' | 'lactate' | 'cortisol' | 'electrolytes';
...
export type BiosensorAlertType = 'threshold_exceeded' | 'threshold_below' | 'sudden_change' | 'trend_anomaly' | 'device_malfunction' | 'low_battery' | 'lost_connection';
...
export type AuditAction = 'create' | 'read' | 'update' | 'delete' | 'export' | 'share' | 'login' | 'logout' | 'failed_login' | 'permission_change' | 'consent_change' | 'data_breach_attempt';
export type ResourceType = 'patient' | 'medical_image' | 'diagnostic_result' | 'lab_result' | 'sensor_data' | 'user' | 'baa' | 'encryption_key' | 'audit_log';
...
export type BreachType = 'unauthorized_access' | 'data_loss' | 'ransomware' | 'phishing' | 'insider_threat' | 'misconfiguration' | 'third_party_breach';
...
export type ComplianceReportType = 'hipaa_security_rule' | 'hipaa_privacy_rule' | 'hipaa_breach_notification' | 'baa_review' | 'access_controls' | 'encryption_audit' | 'incident_response';
...
export type ExperimentType = 'classification' | 'regression' | 'segmentation' | 'time_series_forecasting' | 'anomaly_detection' | 'drug_discovery' | 'protein_folding';
...
export type SignalOperation = 'filter_lowpass' | 'filter_highpass' | 'filter_bandpass' | 'fft' | 'wavelet_transform' | 'normalize' | 'detrend' | 'resample' | 'feature_extraction';
...
export type UltrasoundType = 'dating' | 'nuchal_translucency' | 'anatomy' | 'growth' | 'doppler' | 'biophysical_profile';
...
export type MaternalAlertType = 'gestational_diabetes_risk' | 'preeclampsia_risk' | 'preterm_labor_risk' | 'fetal_distress' | 'abnormal_weight_gain' | 'missed_appointment' | 'critical_lab_value' | 'device_disconnected';
...
export type UserRole = 'patient' | 'clinician' | 'radiologist' | 'pathologist' | 'researcher' | 'admin' | 'compliance_officer' | 'data_scientist';
...
export type NotificationType = 'diagnostic_result' | 'imaging_complete' | 'alert' | 'appointment_reminder' | 'lab_result' | 'medication_reminder' | 'system_maintenance' | 'security_alert';
...
export type AnalyticsReportType = 'platform_usage' | 'clinical_outcomes' | 'model_performance' | 'patient_engagement' | 'financial' | 'quality_metrics';
...
export type ExportType = 'patient_data' | 'diagnostic_reports' | 'imaging_studies' | 'audit_logs' | 'research_dataset' | 'compliance_report';
