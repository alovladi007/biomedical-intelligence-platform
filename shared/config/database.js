...
exports.initializeTimescaleDB = initializeTimescaleDB;
exports.query = query;
...
async function setupCompressionPolicies(client) {
...
async function setupRetentionPolicies(client) {
...
async function createContinuousAggregates(client) {
