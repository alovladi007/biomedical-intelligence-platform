...
import { Microscope, Image, Scan, FileImage, CheckCircle, Star, Menu, X, Phone, Mail, Clock, PlayCircle, ArrowRight } from 'lucide-react'
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-2.5">
              <div className="bg-gradient-to-br from-indigo-600 to-indigo-700 p-2 rounded-lg">
                <Microscope className="h-6 w-6 text-white" strokeWidth={2.5} />
              </div>
              <div>
                <div className="text-lg font-bold text-gray-900">Medical Imaging AI</div>
                <div className="text-xs text-gray-500">DICOM & AI Analysis</div>
              </div>
            </div>
            ...
            <div className="hidden md:flex items-center gap-6">
              ...
              <button className="px-5 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-semibold rounded-lg transition shadow-md">
                Get Started
              </button>
            </div>
          ...
          <div className="grid lg:grid-cols-5 gap-8">
            <div className="lg:col-span-3 space-y-6">
              ...
              <h1 className="text-4xl lg:text-5xl font-extrabold text-gray-900 leading-tight">
                Advanced
                <span className="text-indigo-600"> Medical Imaging AI</span>
              </h1>

              <p className="text-lg text-gray-600">
                Comprehensive dicom & ai analysis with advanced features, real-time monitoring, and enterprise-grade security.
              </p>

              <div className="flex flex-wrap gap-3">
                <Link href="/dashboard" className="inline-flex items-center gap-2 px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-lg transition shadow-lg">
      ...
      <section className="py-12 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-r from-indigo-600 to-indigo-700 rounded-2xl p-10 text-center text-white shadow-2xl">
            ...
            <p className="text-lg mb-6 opacity-90">Experience the power of Medical Imaging AI</p>
            <div className="flex flex-wrap gap-4 justify-center">
              <Link href="/dashboard" className="px-7 py-3 bg-white text-indigo-600 font-bold rounded-lg hover:bg-gray-100 transition shadow-xl">
                Open Dashboard
              </Link>
              <button className="px-7 py-3 bg-transparent border-2 border-white text-white font-bold rounded-lg hover:bg-white hover:text-indigo-600 transition">
                Request Demo
              </button>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-sm text-gray-400 mb-3">DICOM & AI Analysis</p>
