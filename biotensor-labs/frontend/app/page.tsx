...
import { FlaskConical, Cpu, BarChart3, Rocket, CheckCircle, Star, Menu, X, Phone, Mail, Clock, PlayCircle, ArrowRight } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-purple-50">
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <div className="text-xs text-gray-500">MLOps & Model Management</div>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-5 gap-8">
            <div className="lg:col-span-3 space-y-6">
              ...
              <h1 className="text-4xl lg:text-5xl font-extrabold text-gray-900 leading-tight">
                Advanced
                <span className="text-purple-600"> BioTensor Labs</span>
              </h1>

              <p className="text-lg text-gray-600">
                Comprehensive mlops & model management with advanced features, real-time monitoring, and enterprise-grade security.
              </p>
              ...
              <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-4 text-center">
                    <div className="text-3xl font-extrabold text-purple-600">99.9%</div>
      ...
      <section className="py-12 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-r from-purple-600 to-purple-700 rounded-2xl p-10 text-center text-white shadow-2xl">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Get Started?</h2>
            <p className="text-lg mb-6 opacity-90">Experience the power of BioTensor Labs</p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-sm text-gray-400 mb-3">MLOps & Model Management</p>
