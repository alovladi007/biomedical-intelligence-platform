...
import { Brain, Activity, TrendingUp, Users, CheckCircle, Star, Menu, X, Phone, Mail, Clock, PlayCircle, ArrowRight } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50">
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <div className="text-xs text-gray-500">Medical Intelligence Platform</div>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-5 gap-8">
            <div className="lg:col-span-3 space-y-6">
              ...
              <h1 className="text-4xl lg:text-5xl font-extrabold text-gray-900 leading-tight">
                Advanced
                <span className="text-blue-600"> AI Diagnostics</span>
              </h1>

              <p className="text-lg text-gray-600">
                Comprehensive medical intelligence platform with advanced features, real-time monitoring, and enterprise-grade security.
              </p>

              <div className="flex flex-wrap gap-3">
                <Link href="/dashboard" className="inline-flex items-center gap-2 px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition shadow-lg">
      ...
      <section className="py-12 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-10 text-center text-white shadow-2xl">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Get Started?</h2>
            <p className="text-lg mb-6 opacity-90">Experience the power of AI Diagnostics</p>
            <div className="flex flex-wrap gap-4 justify-center">
              <Link href="/dashboard" className="px-7 py-3 bg-white text-blue-600 font-bold rounded-lg hover:bg-gray-100 transition shadow-xl">
                Open Dashboard
              </Link>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-sm text-gray-400 mb-3">Medical Intelligence Platform</p>
